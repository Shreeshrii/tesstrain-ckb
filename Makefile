...
# Training Build Type - Impact, Minus, Plus, Layer or Scratch. Default: '$(BUILD_TYPE)'
BUILD_TYPE := Scratch
...
help:
	...
	@echo "    BUILD_TYPE         Training Type - Impact, Minus, Plus, Layer or Scratch. Default: '$(BUILD_TYPE)'"
...
ifneq (,$(filter $(BUILD_TYPE),Plus Minus))
